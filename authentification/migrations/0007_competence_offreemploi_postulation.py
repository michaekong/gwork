...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('authentification', '0006_remove_travailleur_latitude_range_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('competences_requises', models.ManyToManyField(related_name='offres', to='authentification.competence')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('offre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='postulations', to='authentification.offreemploi')),
